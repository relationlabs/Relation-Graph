...
impl FromStr for NamedNode {
    ...
    ///
    /// ```
    /// use ic_graph_core::model::NamedNode;
    /// use std::str::FromStr;
    ///
...
impl FromStr for BlankNode {
    ...
    ///
    /// ```
    /// use ic_graph_core::model::BlankNode;
    /// use std::str::FromStr;
    ///
...
impl FromStr for Literal {
    ...
    ///
    /// ```
    /// use ic_graph_core::model::{Literal, NamedNode, vocab::xsd};
    /// use std::str::FromStr;
    ///
...
impl FromStr for Term {
    ...
    ///
    /// ```
    /// use ic_graph_core::model::{Literal, Term};
    /// use std::str::FromStr;
    ///
